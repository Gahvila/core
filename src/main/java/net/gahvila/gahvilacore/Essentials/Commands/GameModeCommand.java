    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (Bukkit.getPlayer(args[1]) == null) {
                p.sendMessage(ChatColor.RED + "Ei voitu löytää pelaajaa " + args[1] + "!");
                return true;
            }
            ...
            if (args[0].equalsIgnoreCase("0") || args[0].equalsIgnoreCase("s") || args[0].equalsIgnoreCase("survival")) {
                ...
                p2.sendMessage("Pelitilasi on nyt selviytymistila.");
                p.sendMessage("Asetit pelaajan " + p2.getName() + " pelitilaksi selviytymistila.");
                return true;
            }

            else if (args[0].equalsIgnoreCase("1") || args[0].equalsIgnoreCase("c") || args[0].equalsIgnoreCase("creative")) {
                p2.setGameMode(GameMode.CREATIVE);
                p2.sendMessage("Pelitilasi on nyt luova.");
                p.sendMessage("Asetit pelaajan " + p2.getName() + " pelitilaksi luova.");
                return true;
            }

            else if (args[0].equalsIgnoreCase("2") || args[0].equalsIgnoreCase("a") || args[0].equalsIgnoreCase("adventure")) {
                p2.setGameMode(GameMode.ADVENTURE);
                p2.sendMessage("Pelitilasi on nyt seikkailutila.");
                p.sendMessage("Asetit pelaajan " + p2.getName() + " pelitilaksi seikkailutila.");
                return true;
            }
                ...
                p2.sendMessage("Pelitilasi on nyt katselutila.");
                p.sendMessage("Asetit pelaajan " + p2.getName() + " pelitilaksi katselutila.");
                return true;
            }
