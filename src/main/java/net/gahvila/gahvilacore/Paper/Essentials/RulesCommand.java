        ...
        if (sender instanceof Player) {
            ...
            if (args.length == 1) {
                ...
                switch (args[0]){
                    ...
                    case "text2":
                        p.sendMessage("");
                        p.sendMessage("§fSäännöt voidaan lyhentää helposti kolmeen sanaan, “älä ole tyhmä.” Jos ymmärrät mitä tällä tarkoitetaan, ei sinun välttämättä tarvitse lukea sääntöjä loppuun. Valitettavasti vuosi on " + LocalDate.now().getYear() + ", ja osa ei valitettavasti pysty harkitsemaan kolmen maagisen sanan tarkoitusta.");
