package net.gahvila.gahvilacore.Paper.RankFeatures.Pro.Prefix.Menu.ColorSelectors;
...
public class ColorSelectorName {

    //Prefix menu
    public static void openColorMenuName(Player p){
        Inventory inv = Bukkit.createInventory(p, 18, "§8» §8Värin valinta: §lNimi" );
